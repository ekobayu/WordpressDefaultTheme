...
get_header(); ?>
    ...
    <section class="banner-parallax overlay-dark" data-parallax="scroll"> 
        <div class="inner-banner">
            <h3><?php
				if ( is_day() ) :
					printf( __( 'Daily Archives: %s', 'microfiber' ), get_the_date() );
				elseif ( is_month() ) :
					printf( __( 'Monthly Archives: %s', 'microfiber' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'microfiber' ) ) );
				elseif ( is_year() ) :
					printf( __( 'Yearly Archives: %s', 'microfiber' ), get_the_date( _x( 'Y', 'yearly archives date format', 'microfiber' ) ) );
				else :
					_e( 'Tag : ', 'microfiber' ); single_tag_title();
				endif;
			?></h3>
        </div>
    </section>
