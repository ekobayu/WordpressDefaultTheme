                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="primary-heading1">
                                                <a href="<?php echo esc_url( get_category_link( 2 ) ); ?>"><h2>Business Solution</h2></a>
                                            </div>
                                            <!-- Secondary Heading -->
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="primary-heading2">
                                                <a href="<?php echo esc_url( get_category_link( 3 ) ); ?>"><h2>Auto Cleaning</h2></a>
                                            </div>
                                            <!-- Secondary Heading -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="primary-heading3">
                                                <a href="<?php echo esc_url( get_category_link( 4 ) ); ?>"><h2>Home Cleaning</h2></a>
                                            </div>
                                            <!-- Secondary Heading -->
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="primary-heading4">
                                                <a href="<?php echo esc_url( get_category_link( 5 ) ); ?>"><h2>Personal Cleaning</h2></a>
                                            </div>
                                            <!-- Secondary Heading -->
                                ...
                                <div class="post-widget">
                                    ...
                                    <div class="p-30 light-shadow white-bg">
                                        <ul class="list-posts">
							                ...
							                if ($custom_posts->have_posts()): 
							                    while ($custom_posts->have_posts()): $custom_posts->the_post(); $category = get_the_category(); ?>
